...
public class SortingAlgoTest {
    ...
    public void runTests() {
        mergeSortSimpleTest();
        mergeSortAlreadySortedTest();
        mergeSortDuplicateNumbersTest();
        mergeSortNegativeNumbersTest();
        quickSortSimpleTest();
    }
    ...
    @Test public void mergeSortAlreadySortedTest() {
        assertArrayEquals(new int[] {1, 2, 6, 7, 12, 19, 21}, MergeSort.mergeSort(new int[] {1, 7, 2, 19, 12, 6, 21}));
    }
    ...
    @Test public void quickSortAlreadySortedTest() {
        assertArrayEquals(new int[] {1, 2, 6, 7, 12, 19, 21}, QuickSort.quickSort(new int[] {1, 7, 2, 19, 12, 6, 21}));
    }

    @Test public void quickSortNegativeNumbersTest() {
        assertArrayEquals(new int[] {-25, -5, 0, 5, 10, 15, 50}, QuickSort.quickSort(new int[] {50, -25, -5, 5, 10, 15, 0}));
    }

    @Test public void quickSortSDuplicateNumbersTest() {
